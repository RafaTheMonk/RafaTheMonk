...
- 🎓 **Instructor @ SENAI**, teaching *Data & AI Fundamentals*
...
**🏛️ AI Software Engineering Intern, TCU / NIA** · *2026 - Present*
Building real software with Claude Code, AI agent orchestration, and MCP for the Intelligent Software Factory pilot. Documenting LLM-driven development for TCU's IT department.

**🎓 Instructor, SENAI** · *Present*
Teaching *Fundamentos de Dados e Inteligência Artificial* (Data & AI Fundamentals).

**🖥️ Infrastructure Analyst, Cassi Turismo** · *2023 - Present*
Server, network, firewall, VPN, and proxy administration. Automation reducing resolution time ~25%; database reorganization growing the active base ~35%.
...
|---|---|---|
| 🏆 **Justina AI** | WhatsApp legal assistant for justice access, winner @ Hackathon+ TJBA, in institutional adoption | n8n · Gemini 2.5 Pro · PostgreSQL · WAHA |
| 🏆 **MASA** | Smart food-access platform for low-income families, winner @ HSU2K25 | React · Node.js · AI |
| 🎯 **FiadoPay** | Payment gateway, clean architecture, SOLID, design patterns, fraud validation | Java · Spring Boot · PostgreSQL |
| 🔍 **Radar Editais** | Research-grant collector with scraping, OCR, and AI | Python · OCR · REST API |
